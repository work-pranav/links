...
const LinkComponent = ({content, btnlink}: {content: string, btnlink: string}) => {
  return (
    <a href={btnlink} target="_blank" className="rounded-xl border-2 border-[#a369f4] shadow-custom-purple py-3 hover:shadow-none hover:translate-y-1 transition text-center font-normal text-lg">
      {content}
    </a>
  )
}
